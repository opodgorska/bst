...
Bst-Qt can display and save QR codes for sending
...
Bst-Qt's initial splash screen
...
opening/launching Bst-Qt is available only on Linux,
and only if you configure your desktop to launch
Bst-Qt. All platforms support dragging and dropping
bitcoin: URIs onto the Bst-Qt window to start
payment.
...
It is expected that future releases of Bst-Qt
