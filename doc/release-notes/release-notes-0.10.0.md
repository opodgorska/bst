...
installer (on Windows) or just copy over /Applications/Bst-Qt (on Mac) or
...
- `bd0aa10` Replace the temporary file hack currently used to change Bst-Qt's dock icon (OS X) with a buffer-based solution
