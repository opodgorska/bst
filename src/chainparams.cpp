...
public:
    CMainParams() {
        ...
        //consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000001200120012");
	consensus.nMinimumChainWork = uint256S("0000000000000000000000000000000000000000000000000000006d006d006d");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
	uint256 picoHash = uint256S("c7c823976d866af7168a9a73263206865db8a5de5a1912ea55b161fca249468b");
	assert(consensus.hashGenesisBlock == picoHash);
        assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
