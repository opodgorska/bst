...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("8000000000d34dcc4a6f1312961560bb5db555451d6262cc899e228ebcffcb4c");
        ...
        consensus.nRuleChangeActivationThreshold = 19152; // 95% of nMinerConfirmationWindow
...
public:
    CRegTestParams() {
        ...
        consensus.BIP65Height = 4640; // BIP65 activated on regtest (Used in rpc activation tests)
        ...
        consensus.nRuleChangeActivationThreshold = 870; // 75% of testchains
        consensus.nMinerConfirmationWindow = 1160; // Faster than normal for regtest (144 instead of 20160)
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        ...
        nDefaultPort = 18444;
        nPruneAfterHeight = 1835;

        genesis = CreateGenesisBlock(1534749679, 1, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        uint256 picoHash = uint256S("84cd117a4a11a3636095b58fb2462408a8119b6f7e97a5f8d376b471d2ac17ed");
        assert(consensus.hashGenesisBlock == picoHash);
        assert(genesis.hashMerkleRoot == uint256S("6f244d2d32e34b70fd35d149614c5cfc15842fd48dfd556b5bd06528fc6cced7"));
