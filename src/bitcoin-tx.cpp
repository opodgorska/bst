...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bst-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bst-tx [options] <hex-tx> [commands]  Update hex-encoded BlockStamp transaction\n" +
            "or:     bst-tx [options] -create [commands]   Create hex-encoded BlockStamp transaction\n" +
            "\n";
